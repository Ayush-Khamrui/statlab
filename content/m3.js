...
<ul>
<li>$P(H)$ — <b>prior</b>: belief before the evidence</li>
<li>$P(E\\mid H)$ — <b>likelihood</b>: how well $H$ predicts the evidence</li>
<li>$P(H\\mid E)$ — <b>posterior</b>: updated belief after seeing $E$</li>
<li>$P(E)=\\sum_i P(E\\mid H_i)P(H_i)$ — <b>evidence</b> (normaliser, by total probability)</li>
</ul></div>
...
<div class="callout example" data-icon="✏️"><div class="callout-title">The base-rate surprise, worked</div><p>Disease in 1% of people. Test catches 99% of true cases, falsely flags 5% of healthy. You test positive — how worried? $P(+) = (0.99)(0.01)+(0.05)(0.99)=0.0594$. $P(\\text{disease}\\mid +)=\\frac{(0.99)(0.01)}{0.0594}\\approx \\mathbf{17\\%}$. Only 17%! Switching to natural frequencies (10 sick of 1000, ~50 false alarms) makes it obvious.</p></div>

<h2>From one feature to many: Naïve Bayes</h2>
<p>Real classifiers use many clues $X_1,\\dots,X_n$ at once. Estimating $P(X_1,\\dots,X_n\\mid C)$ honestly is impossible — too many combinations. So we make one bold assumption.</p>
...
<div class="callout definition" data-icon="📐"><div class="callout-title">Random variable</div><p>A <b>random variable</b> $X$ is a function from the sample space to the real numbers — it assigns one number to each outcome.</p>
...
`
    },
    {
      ...
      html: `
<p class="lead">Identifying which <strong>pattern</strong> your data follows is half of modelling. A handful of named distributions cover most of what you'll meet — and they're deeply connected.</p>
